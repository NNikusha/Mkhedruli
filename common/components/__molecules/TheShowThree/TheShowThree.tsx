            ...
            <div className="px-[40px] w-full h-full flex">
                <div className='flex flex-col   lg:flex-row-reverse  items-center '>
                    <div className='flex flex-col relative   items-center  mt-[150px] '>
                        ...
                        <div className='bg-[#1F1F1F] w-full h-fit rounded-[10px] text-white px-4 py-2 xl:hidden'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita, delectus?</div>
